...
### Diagnosis
Onset of the disease is slow and early symptoms are often dismissed as normal signs of ageing. A diagnosis is typically given based on history of illness, cognitive tests, medical imaging, and blood tests.
...
## Project Motivation
The Alheimer's Association estimates nearly 6 million Americans suffer from the disease and is the 6th leading cause of death in the US. The estimated cost of AD was $277 billion just in the US. They estimate *early and accurate* diagnoses could save up to $7.9 trillion in medical and care costs over the next 30 years. 

Sources: [Mayo Clinic](https://www.mayoclinic.org/diseases-conditions/alzheimers-disease/symptoms-causes/syc-20350447 "Mayo Clinic - Alzheimer's Disease")
